...
const SignIn = () => {
  ...
  const signIn = () => {
    ...
    if (role == "student") {
      ...
      url = "https://siweslogbook.pythonanywhere.com/login";
    }
      ...
      <>
        ...
        <main className="container mx-auto my-28 max-w-[500px] border-[#f3f2f2] border-[1px] shadow-lg p-8 flex flex-col">
          <div className="flex flex-row">
            <h1 className=" w-full flex justify-end text-2xl text-center font-bold p-4 text-blue-500">
              Sign In
            </h1>
            <div className="w-full flex justify-end">
              ...
              >
                ...
                <option value="student" className="w-[100%]">
                  Student
                </option>
                <option value="supervisor" className="w-[100%]">
                  Supervisor
                </option>
          ...
          />
          <div className="flex flex-row">
            <label htmlFor="remember_me" className="mr-4">
              Remember me
            </label>
            <input
              type="checkbox"
          ...
          <p className="my-4">
            Not yet registered?
            <Link href={"/register"} className="italic underline text-blue-500">
              Register
            </Link>
          </p>
          <button
